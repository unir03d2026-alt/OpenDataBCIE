...
from pipelines.training_pipeline import train_mixed_clustering
...
def main():
    ...
    logging.info(">>> INITIATING BCIE MIXED CLUSTERING PIPELINE (GOWER + HIERARCHICAL) <<<")
    ...
    try:
        train_mixed_clustering(config_path)
    except Exception as e:
